...
def build_vit(config, pt_type='origin'):
    ...
    rank0_print(f"Loading pretrained weights from /mnt/petrelfs/share_data/lixinhao/models/internvideo2/avp_1b_f4_coco_smit_e4_vision.pt")
    state_dict = torch.load("/mnt/petrelfs/share_data/lixinhao/models/internvideo2/avp_1b_f4_coco_smit_e4_vision.pt", map_location='cpu')
