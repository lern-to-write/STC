...
class ToMe64_mlp(nn.Module):
    ...
    def forward(self, x, local_num_frames): # 单帧64
        ...
        num_tome_tokens = local_num_frames * 64
    ...
    @property
    def config(self):
        return {"mm_projector_type": "tome64_mlp"}
...
if __name__ == "__main__":
    ...
    connector = ToMe64_mlp(config=config, vision_cfg=vision_cfg)
